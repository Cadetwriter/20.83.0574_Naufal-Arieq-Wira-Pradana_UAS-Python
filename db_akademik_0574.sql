...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 27, 2022 at 04:10 AM
...
--
-- Database: `db_akademik_0574`
--

-- --------------------------------------------------------

--
-- Table structure for table `tbl_students_0574`
--

CREATE TABLE `tbl_students_0574` (
...
--
-- Dumping data for table `tbl_students_0574`
--

INSERT INTO `tbl_students_0574` (`No`, `NIM`, `Nama`, `JK`, `Jurusan`, `Alamat`) VALUES
('No', 'NIM', 'Nama', 'JK', 'Jurusan', 'Alamat'),
('1', '20.90.1234', 'Mansur Tri', 'L', 'Teknik Komputer', 'Yogyakarta'),
('2', '20.90.1235', 'Agung Surya', 'L', 'Informatika', 'Slema'),
